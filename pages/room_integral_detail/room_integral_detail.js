...
Page({
    ...
    getCommonDetail: function () {
        roomModel.getIntegralDetail(this.data.product_id, this.data.checkInDate, this.data.checkOutDate, this.data.selVal, (data) => {
            this.data.order_url = this.data.order_url + "?type=room&is_integral=1&rush_id=0&id=" + this.data.product_id;
