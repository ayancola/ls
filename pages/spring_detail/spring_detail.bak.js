...
Page({
    ...
    onLoad: function (options) {
        ...
        app.globalData.shopNum = this.data.num;
        app.globalData.shopDate = this.data.choose_day;
        shopModel.getShopDetail(this.data.is_rush, this.data.product_id, this.data.rush_id, is_integral, is_ready, (data) => {
            WxParse.wxParse('content', 'html', data.content, this, 0);
            if (is_rush = 1 || is_rush == '1') {
